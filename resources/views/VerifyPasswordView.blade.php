                        ...
                        <tr>
                          <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
                            <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                              <h1 class="h1" style="color:#202020;display:block;font-family:Arial;font-size:24px;font-weight:bold;line-height:100%;margin-top:20px;margin-right:0;margin-bottom:20px;margin-left:0;text-align:center;">Verify Your Password Change</h1>
                        ...
                        <tr>
                          <td valign="top" width="100%" style="border-collapse:collapse;">
                            ...
                            <div style="text-align: center; color: #c9c9c9;">
                              <p style="color: red">NOTE : IF YOU DIDN'T REQUEST A PASSWORD CHANGE, DON'T CLICK ON THE LINK</p>
                            </div>
                            <br>
                          </td>
                        </tr>
